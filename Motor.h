...
private:
	...
	// if that is the case, for controlling motor speed pinA should be PWM capable
...
public:
	...
	void setPins( unsigned char _pinA, unsigned char _pinB, unsigned char _pinPWM = 255);
